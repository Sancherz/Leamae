...
<div class="form-group">
      ...
      <input type="name" class="form-control" id="exampleFormControlInput1" placeholder="Leamae">
    </div>

    <div class="form-group">
      <label for="exampleFormControlInput1">Last Name: </label>
      <input type="surename" class="form-control"id="exampleFormControlInput1" placeholder="Sanchez">
  </div>
